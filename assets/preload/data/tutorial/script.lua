...
--]]
local defaultPosX = {0,0,0,0}
local defaultPosY = {0,0,0,0}
local offset = 100

function onCreatePost() 
	defaultPosX[1] = defaultPlayerStrumX0
	defaultPosX[2] = defaultPlayerStrumX1
	defaultPosX[3] = defaultPlayerStrumX2
	defaultPosX[4] = defaultPlayerStrumX3

	defaultPosY[1] = defaultPlayerStrumY0
	defaultPosY[2] = defaultPlayerStrumY1
	defaultPosY[3] = defaultPlayerStrumY2
	defaultPosY[4] = defaultPlayerStrumY3

	debugPrint(defaultPosY[1]) 
end
...
function onBeatHit()	
	...
	if difficulty > 2 then	 --To disable pincers for easy, normal and hard difficulty
		...
		elseif curBeat == 20 then
			qtMod_PincerGrab(1)
			if downscroll then
				qtMod_PincerTweenY("NoteMovePincer1",1,(defaultPosY[1]-55)+offset,0.5, quadinout)
		...
		elseif curBeat == 22 then
			...
			if downscroll then
				qtMod_PincerTweenY("NoteMovePincer2Y",4,(defaultPosY[3]-55)+offset,0.5, quadinout)
			...
			qtMod_PincerTweenX("NoteMovePincer2X",4,(defaultPosX[4]+75)+offset,0.5, quadinout)
		...
		elseif curBeat == 36 then
			qtMod_PincerGrab(3)
			if downscroll then
				qtMod_PincerTweenY("NoteMovePincer3",3,(defaultPosY[3]-100)+offset,0.5, quadinout)
		...
		elseif curBeat == 96 and difficulty ~= 3 then
			...
			qtMod_PincerTweenY("NoteMovePincerReset1Y",1,defaultPlayerStrumY0+offset,1, quadinout)
			noteTweenY("NoteMoveReset1Y",4,defaultPlayerStrumY0,1, quadinout)
			
			qtMod_PincerTweenX("NoteMovePincerReset2X",2,defaultPlayerStrumX1+offset,1, quadinout)
			noteTweenX("NoteMoveReset2X",5,defaultPlayerStrumX1,1, quadinout)
			qtMod_PincerTweenY("NoteMovePincerReset2Y",2,defaultPlayerStrumY1+offset,1, quadinout)
			noteTweenY("NoteMoveReset2Y",5,defaultPlayerStrumY1,1, quadinout)
			
			qtMod_PincerTweenX("NoteMovePincerReset3X",3,defaultPlayerStrumX2+offset,1, quadinout)
			noteTweenX("NoteMoveReset3X",6,defaultPlayerStrumX2,1, quadinout)
			qtMod_PincerTweenY("NoteMovePincerReset3Y",3,defaultPlayerStrumY2+offset,1, quadinout)
			noteTweenY("NoteMoveReset3Y",6,defaultPlayerStrumY2,1, quadinout)
			
			qtMod_PincerTweenX("NoteMovePincerReset4X",4,defaultPlayerStrumX3+offset,1, quadinout)
			noteTweenX("NoteMoveReset4X",7,defaultPlayerStrumX3,1, quadinout)
			qtMod_PincerTweenY("NoteMovePincerReset4Y",4,defaultPlayerStrumY3+offset,1, quadinout)
