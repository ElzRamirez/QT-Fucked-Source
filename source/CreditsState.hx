...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Extra Mod Credits'],
			['Iandee',				'iandee',			'Creator of the Original Design of the BF and GF Sprites from the VS Impostor Dialogues and Ara Speaker Sprite',		'https://www.youtube.com/channel/UCnoOhpnxHWtayIJUCutfP7w',			'B0B0B0'],
